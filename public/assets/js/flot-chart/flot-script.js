...
$(function() {
    ...
    var data4_errors = [0.1, 0.4, 0.2];
        ...
        var data = [
            {color: "#59a6fe", points: data1_points, data: data1, label: "data1"}, 
            {color: "#ff5a75",  points: data2_points, data: data2, label: "data2"},
            {color: "#bca0ee", lines: {show: true}, points: data3_points, data: data3, label: "data3"},
            {color: "#38d3e7", bars: {show: true, align: "center", barWidth: 0.25}, data: data4, label: "data4"},
...
$(function() {
    ...
    $.plot('#default-pie-flot-chart', data, {
        ...
        colors: ["#ab8ce4", "#26c6da" ,"#00c292" ,"#4099ff" ,"#FF5370", "#00c292" ,"#00c292"]
    });
